...
let _rawBase = import.meta.env.VITE_API_URL || 'https://lexguard-ai-p6aa.onrender.com/api/v1';
_rawBase = _rawBase.replace(/\/$/, ''); // strip trailing slash
if (!_rawBase.endsWith('/api/v1')) {
  _rawBase += '/api/v1';
}
